...
for file in cell_neighbor_file : 
    ...
    with open(cmd_path + file[0:4]+'_删除小区邻区.txt','a') as f:
    ...
    with open(cmd_path + file[0:4]+'_添加小区邻区.txt','a') as f:
...
for file in carrie_neighbor_file : 
    ...
    with open(cmd_path + file[0:4]+'_删除载频邻区.txt','a') as f:
    ...
    with open(cmd_path + file[0:4]+'_添加载频邻区.txt','a') as f:
