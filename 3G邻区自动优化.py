...
=======
=======
>>>>>>> parent of 85d7a42... 删除大文件：信用卡欺诈检测
=======
>>>>>>> parent of 85d7a42... 删除大文件：信用卡欺诈检测
=======
>>>>>>> parent of 85d7a42... 删除大文件：信用卡欺诈检测

data_path = r'd:\3G邻区自动优化\原始数据' + '\\'
>>>>>>> parent of 85d7a42... 删除大文件：信用卡欺诈检测
...
df_cell_config = df_cell_config.rename(columns = {'pilot_pn':'Scell_pn','pilot_pn':'Scell_name'})
...
df_handover = df_handover[['neighbor_index','切换总次数','切换成功次数','切换成功率(%)']]
...
# 检查小区邻区
# =============================================================================
df_cell = df_cell_neighbor[['system','cellid','neighbor_pn','ncellsystemid','ncellid','alias_b','neighbor_index']]
