...
df_eric = df_eric[['DATE_ID', 'eNodeB', 'EUTRANCELLFDD', 'Max number of UE in RRc', 'Air Interface_Traffic_Volume_UL_MBytes','Air Interface_Traffic_Volume_DL_MBytes']]
...
df_eric_busy = df_eric[['DATE_ID', 'eNodeB', 'EUTRANCELLFDD', 'Max number of UE in RRc', 'DL_Util_of_PRB']]
...
df_tmp = df_eric_busy.head(10)


df_zte = pd.read_csv('./原始数据/2020_03_19_11_51_59_279_qj_wxzx_zhouchaocheng_2439.csv', encoding = 'gbk')
