...
df1 = df_busy_cell_count_1800[df_busy_cell_count_1800['区县'] == '']

df_country_1800 = pd.pivot_table(df_busy_cell_count_1800, index=['区县'],
                                                           values =['小区名称'],
                                                           aggfunc = {'小区名称':'count'})
...
df_country_800 = pd.pivot_table(df_busy_cell_count_800, index=['区县'],
                                                           values =['小区名称'],
                                                           aggfunc = {'小区名称':'count'})
