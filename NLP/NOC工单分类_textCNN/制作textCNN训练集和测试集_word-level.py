...
path = r'D:\_python小程序\NOC工单分类_textCNN'
os.chdir(path)
...
# 分词
df['cut_word'] = cutWords(df['text'],stopwords)

# 拆分训练集和测试集
X_train, X_test_vaild, y_train, y_test_vaild = train_test_split(df.cut_word, df.label, test_size=0.3, stratify=df.label, shuffle=True, random_state=41)
